...
/// <summary>
/// Managed, redistributable emulation software for Switch.
...
public static class EmulatorCatalog
{
    ...
    [
        new("tico", "tico frontend", "Multi-system launcher", EmulationSourceKind.GitHubRelease, "ticohq/tico", "tico.nro", "switch/tico/tico.nro", EmulationInstallMode.DirectFile, true, "Controller-first frontend; the current stable upstream release is resolved dynamically. Its own core manager remains available on the Switch."),
        new("retroarch", "RetroArch + stable core/asset bundle", "Multi-system / libretro", EmulationSourceKind.OfficialBundle, "", "RetroArch.7z", "", EmulationInstallMode.ArchiveToRoot, true, "Official Libretro Switch stable bundle. User configuration, saves, states, playlists, thumbnails and BIOS/system files are preserved.", RetroArchPreserve),
        ...
        new("tico-dolphin", "tico Dolphin", "GameCube / Wii", EmulationSourceKind.GitHubRelease, "ticohq/tico-dolphin", "tico-dolphin.nro", "tico/cores/tico-dolphin.nro", EmulationInstallMode.DirectFile, true, "Tico GameCube/Wii core."),
        ...
        new("tico-duckstation", "tico DuckStation", "PlayStation", EmulationSourceKind.GitHubRelease, "ticohq/tico-duckstation", "tico-duckstation.nro", "tico/cores/tico-duckstation.nro", EmulationInstallMode.DirectFile, true, "Current Tico PlayStation core; replaces the older SwanStation path."),
        ...
        new("tico-melonds", "tico melonDS", "Nintendo DS", EmulationSourceKind.GitHubRelease, "ticohq/tico-melonds", "tico-melonds.nro", "tico/cores/tico-melonds.nro", EmulationInstallMode.DirectFile, false, "Tico melonDS source is public, but the upstream repository currently does not expose a GitHub release asset. MewNX therefore documents it without enabling automatic deployment until a compatible release is published.")
    ];
